...
final class OpenAIChatCompletionsUsageExtractor implements UsageExtractorInterface
{
    /**
    ...
    public function extract(array $payload): UsageBreakdown
    {
        ...
        if (!is_string($model)) {
            throw new InvalidUsagePayload('Expected a Chat Completions payload with `model` and `usage`.');
        }
        ...
        return new UsageBreakdown(
            ...
            outputAudioTokens: $this->intFromNested($usage, ['completion_tokens_details', 'audio_tokens']),
