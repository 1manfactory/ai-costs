...
| Anthropic | `claude-opus-4-7`, `claude-sonnet-4-6`, `claude-haiku-4-5` | `standard`, `batch` | `2026-07-08` |
| Google Gemini | `gemini-2.5-pro`, `gemini-2.5-flash`, `gemini-2.5-flash-lite` | `standard`, `batch`, `flex`, `priority` | `2026-07-08` |
